...
public class CompressorRecipeManager {
     ...
     * @param absolute
     */
    public static void addNeutroniumCompressorRecipe(ItemStack output, ItemStack input, int inputAmount,
                                                     boolean absolute) {
        if (input == null) {
            ...
            ICompressorRecipe recipe = new CompressorRecipe(output, inputAmount, absolute,
                    Collections.singletonList(Ingredient.fromStacks(input)));

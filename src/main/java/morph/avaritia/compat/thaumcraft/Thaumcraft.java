...
import morph.avaritia.util.ItemHelper;
...
public class Thaumcraft {
    ...
    public static void registerTCRecipes() throws ItemNotFoundException {
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Avaritia.MOD_ID, "darkhold"), new InfusionRecipe(
                ...
                12,
                new AspectList().add(Aspect.MAGIC, 500).add(Aspect.AURA, 250).add(Aspect.FLUX, 250).add(Aspect.DARKNESS, 250).add(Aspect.ELDRITCH, 250).add(Aspect.SOUL, 250).add(Aspect.MAN, 250),
